            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col text-end">
                        <button class="btn btn-danger  " data-bs-toggle="modal" data-bs-target="#themmoiphong">thêm mới</button>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <table class="table table-bordered ">
                    ...
                    <div class="modal fade" id="themmoiphong" tabindex="-1" aria-labelledby="exampleModalLabel"
                        aria-hidden="true">
                        <div class="modal-dialog modal-lg " style="background: white;">
                            <div class="modal-content">
                                <div class="modal-header">
...
export default {
    ...
    methods: {
        ...
        checkSlugUpdate() {
            axios
                .post('http://127.0.0.1:8000/api/admin/danh-muc/check-slug-update', this.update_loai_phong)
                .then((res) => {
                    if (res.data.status == 1) {
